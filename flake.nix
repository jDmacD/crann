{
  inputs = {
    ...
    multiverse.url = "github:fzakaria/nixpkgs-multiverse?rev=b780524b47fbe8b9ae8605a761a8fe9ad1a8e48b";
    ...
    noctalia = {
      url = "github:noctalia-dev/noctalia?rev=8c52cb71b5bcafbf67bfb8e659f1fc45f882a008";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    stylix = {
