{
  inputs = {
    ...
    import-tree.url = "github:vic/import-tree?rev=8961e2418a12a71e08943c9f3d8cf6dbbc3cd172";

    multiverse.url = "github:fzakaria/nixpkgs-multiverse?rev=25b80f6630c67de61613a6e1d461929b01f63a47";
    ...
    home-manager = {
      url = "github:nix-community/home-manager?rev=f772b7f968365e7b2b70a860c509d214639556fe";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    niri = {
      # url = "github:sodiboo/niri-flake?rev=21777ada91b8b0d91a61c78294467eed232db936";
      url = "github:epireyn/niri-flake?rev=8c4cf2a8d3e42ca2db41b884eef333e674ecc09f";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    noctalia = {
