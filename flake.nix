{
  inputs = {
    nixpkgs.url = "github:nixos/nixpkgs/00266915b167c70a0d4bc1641e45dbdd2a2c1b16";
    ...
    multiverse.url = "github:fzakaria/nixpkgs-multiverse?rev=f743c98390a71f8afbe2e180cc4d1a5672f257bd";
    ...
    home-manager = {
      url = "github:nix-community/home-manager?rev=a26f7158fbc4aa740fcc7fa79a01e1ed29910bc2";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    niri = {
    ...
    noctalia = {
      url = "github:noctalia-dev/noctalia?rev=de4867dd1bdbfc30454f4465e1ef18a126bfe381";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    stylix = {
    ...
    llm-agents = {
      url = "github:numtide/llm-agents.nix?rev=f01ba915dc33c18a683dd13ea00c93ada411947e";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    optnix = {
