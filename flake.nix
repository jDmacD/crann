{
  inputs = {
    ...
    multiverse.url = "github:fzakaria/nixpkgs-multiverse?rev=c0a4b9aa6abeb72e0bf44cc6111b7b0424f2836a";
    ...
    home-manager = {
      url = "github:nix-community/home-manager?rev=cd1c9e552f41894aeb5cc5cb353d5a1d61550357";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    niri = {
      # url = "github:sodiboo/niri-flake?rev=21777ada91b8b0d91a61c78294467eed232db936";
      url = "github:epireyn/niri-flake?rev=a4f60da55e1dfa3ea238b531d55126afbb451ef7";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    noctalia = {
      url = "github:noctalia-dev/noctalia?rev=7dcd32a9ace61b6cd4137af2d061976bf8b9c67d";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    stylix = {
    ...
    llm-agents = {
      url = "github:numtide/llm-agents.nix?rev=b29772d957e2b75be1abac607dda74844dd837e4";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    optnix = {
